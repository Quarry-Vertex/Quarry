...
>>>>>>> refs/remotes/origin/main:quarry-sdk/src/bindings/qsat.rs
    ...
    impl ::core::convert::From<OwnableInvalidOwner> for QSATErrors {
        fn from(value: OwnableInvalidOwner) -> Self {
            Self::OwnableInvalidOwner(value)
        }
    }
    impl ::core::convert::From<OwnableUnauthorizedAccount> for QSATErrors {
    ...
    impl ::ethers::contract::EthLogDecode for QSATEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = BurnFilter::decode_log(log) {
                return Ok(QSATEvents::BurnFilter(decoded));
            }
            if let Ok(decoded) = InitializedFilter::decode_log(log) {
                return Ok(QSATEvents::InitializedFilter(decoded));
            }
            if let Ok(decoded) = MintFilter::decode_log(log) {
                return Ok(QSATEvents::MintFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(QSATEvents::OwnershipTransferredFilter(decoded));
            }
    ...
    impl ::core::convert::From<BurnFilter> for QSATEvents {
    ...
    impl ::core::convert::From<MintFilter> for QSATEvents {
        fn from(value: MintFilter) -> Self {
            Self::MintFilter(value)
        }
    }
    impl ::core::convert::From<OwnershipTransferredFilter> for QSATEvents {
    ...
    impl ::core::convert::From<BurnCall> for QSATCalls {
    ...
    impl ::core::convert::From<MintCall> for QSATCalls {
    ...
    impl ::core::convert::From<OwnerCall> for QSATCalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<RenounceOwnershipCall> for QSATCalls {
    ...
    impl ::core::convert::From<TransferOwnershipCall> for QSATCalls {
