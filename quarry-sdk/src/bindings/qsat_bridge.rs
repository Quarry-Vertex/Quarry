...
pub mod qsat_bridge {
    ...
    impl<M: ::ethers::providers::Middleware> QSATBridge<M> {
        ...
        ///Gets the contract's `PegInQSAT` event
        pub fn peg_in_qsat_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<
            ::std::sync::Arc<M>,
            M,
        ...
        ///Gets the contract's `PegOutQSAT` event
        pub fn peg_out_qsat_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<
            ::std::sync::Arc<M>,
            M,
    ...
    #[ethevent(name = "PegInQSAT", abi = "PegInQSAT(address,uint256)")]
    pub struct PegInQSATFilter {
    ...
    #[ethevent(name = "PegOutQSAT", abi = "PegOutQSAT(bytes32,uint256)")]
    pub struct PegOutQSATFilter {
    ...
    pub enum QSATBridgeEvents {
        ...
        PegInQSATFilter(PegInQSATFilter),
        PegOutQSATFilter(PegOutQSATFilter),
    }
    impl ::ethers::contract::EthLogDecode for QSATBridgeEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = PegInQSATFilter::decode_log(log) {
                return Ok(QSATBridgeEvents::PegInQSATFilter(decoded));
            }
            if let Ok(decoded) = PegOutQSATFilter::decode_log(log) {
                return Ok(QSATBridgeEvents::PegOutQSATFilter(decoded));
            }
    ...
    impl ::core::fmt::Display for QSATBridgeEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::PegInQSATFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::PegOutQSATFilter(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    ...
    impl ::core::convert::From<PegInQSATFilter> for QSATBridgeEvents {
        fn from(value: PegInQSATFilter) -> Self {
            Self::PegInQSATFilter(value)
        }
    }
    impl ::core::convert::From<PegOutQSATFilter> for QSATBridgeEvents {
        fn from(value: PegOutQSATFilter) -> Self {
            Self::PegOutQSATFilter(value)
        }
    }
